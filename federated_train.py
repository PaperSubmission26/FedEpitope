...
def main(args):
    ...
    print("=" * 80)
    print("FedEpitope Federated Training")
    print("=" * 80)
    ...
    for client_id in range(NUM_CLIENTS):
        train_dataset = EpitopeDataset(CLIENT_TRAIN_FILES[client_id], tokenizer)
        val_dataset = EpitopeDataset(CLIENT_VAL_FILES[client_id], tokenizer)
    ...
    for round_num in range(1, args.num_rounds + 1):
        ...
        for client_id in range(NUM_CLIENTS):
            ...
            print()
            print("-" * 80)
            print(f"Training client {client_id + 1}: {CLIENT_NAMES[client_id]}")
            print("-" * 80)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--results_dir", type=str, default="results/r2_seed42")
